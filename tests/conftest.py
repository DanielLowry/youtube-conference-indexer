...
def app_ctx(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr(main_module.state, "api_key_status_message", "Validation skipped in tests")
    monkeypatch.setattr(main_module.state, "api_key_validation_ok", True)
